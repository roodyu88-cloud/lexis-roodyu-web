...
const PLACEHOLDER_PRESETS = [
  ...
  { id: "ph-preset-2", name: "Кодекс ПДД", description: "Правила дорожного движения", author: "roodyu2", discordId: "222222222222222222", data: "[]", downloads: 210, isVerified: false, serverProjectId: "ph-project-1", serverId: "ph-server-2", createdAt: new Date("2026-06-10") },
...
const PLACEHOLDER_USERS = [
  { id: "ph-user-1", discordId: "111111111111111111", username: "roodyu", avatar: null, role: "user", badges: JSON.stringify(["Creator", "Staff"]), canUpload: true, isPremium: true, premiumUntil: null, isBanned: false, banReason: null, createdAt: new Date("2026-01-01") },
  { id: "ph-user-2", discordId: "222222222222222222", username: "roodyu2", avatar: null, role: "user", badges: JSON.stringify(["ActivePresetser"]), canUpload: true, isPremium: false, premiumUntil: null, isBanned: false, banReason: null, createdAt: new Date("2026-01-01") },
];
